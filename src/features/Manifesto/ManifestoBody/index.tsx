...
export function ManifestoBody() {
  return (
    ...
    >
      ...
      <p>
        It doesn&rsquo;t matter what you read or listen to: these days, everyone
        is talking about Web3. But when you look past the headlines, something
        remarkable is unfolding: Web3 is fortifying itself. We&rsquo;re washing
        out bad actors and laying the foundation for a new Internet, one
        that&rsquo;s owned by all of us. It&rsquo;s time to get back to basics
        and remind ourselves why we&rsquo;re here.
      </p>
      <h3>
